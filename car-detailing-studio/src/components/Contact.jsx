...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="py-12 bg-gradient-to-br from-neutral-50 to-neutral-100"
    >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label
                    htmlFor="name"
                    className="block text-sm font-semibold text-accent-950 mb-2"
                  >
                    Full Name *
                  </label>
                  <input
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="wheel-tire">Wheel & Tire Care</option>
              ...
              <button
                ...
                className="w-full bg-primary-500 text-accent-950 px-8 py-4 rounded-xl text-lg font-bold hover:bg-primary-400 transition-all duration-300 transform hover:scale-105 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              >
                {isSubmitting ? (
                  <span className="flex items-center justify-center">
                    <svg
                      className="animate-spin -ml-1 mr-3 h-5 w-5 text-accent-950"
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-accent-950 mb-1">
                      Phone
                    </h4>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-700">
                      info@toshkogdetailing.com
                    </p>
                    <p className="text-neutral-700">
                      bookings@toshkogdetailing.com
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-neutral-700">123 Auto Detail Street</p>
                    <p className="text-neutral-700">Detailing City, DC 12345</p>
                    <a
                      href="https://www.google.com/maps/search/123+Auto+Detail+Street,+Detailing+City,+DC+12345"
                      target="_blank"
